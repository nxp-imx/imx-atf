...
void dram_enter_retention(void)
{
	...
	mmio_write_32(CCM_SRC_CTRL(15), 2);
        ...
        /* seem enable/disable iso will make DDR sometime unaccess */
	/* enable the phy iso */
	//mmio_setbits_32(IMX_GPC_BASE + DDRMIX_PGC, 1);
	//mmio_setbits_32(IMX_GPC_BASE + PU_PGC_DN_TRG, DDRMIX_PWR_REQ);
        //while (mmio_read_32(IMX_GPC_BASE + PU_PGC_DN_TRG) &  DDRMIX_PWR_REQ);
...
void dram_exit_retention(void)
{
	...
	//mmio_setbits_32(IMX_GPC_BASE + PU_PGC_UP_TRG, DDRMIX_PWR_REQ);
        // while (mmio_read_32(IMX_GPC_BASE + PU_PGC_UP_TRG) & DDRMIX_PWR_REQ);
